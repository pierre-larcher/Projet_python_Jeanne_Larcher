...
def _calcule_suivante(graphe: Graphe, temps: dict[str, float]) -> dict[str, float]:
    """
...
"""
    ...
    resultat[graphe.depart] = 0.0
    return resultat


def _calcule_temps(graphe: Graphe) -> float:
    """
